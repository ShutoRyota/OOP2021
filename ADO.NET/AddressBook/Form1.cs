...
namespace AddressBook {
    public partial class Form1 : Form {
        ...
        private void btConnect_Click(object sender, EventArgs e) {
            // TODO: このコード行はデータを 'infosys202126DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202126DataSet.Person);
        }

        private void btNameFilter_Click(object sender, EventArgs e) {
            this.personTableAdapter.FillByName(this.infosys202126DataSet.Person, tbNameSearch.Text);
        }
        ...
        private void personDataGridView_SelectionChanged(object sender, EventArgs e) {
                if (personDataGridView.Rows.Count != 0) {
                    ...
                    dtpDate.Value = DateTime.Parse(personDataGridView.CurrentRow.Cells[2].Value.ToString());
        ...
        private void btBirthdayFilter_Click(object sender, EventArgs e) {
            this.personTableAdapter.FillByBirthday(this.infosys202126DataSet.Person, dtpBitrth.Text);
        }
    }
}