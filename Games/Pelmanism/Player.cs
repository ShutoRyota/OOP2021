...
namespace Pelmanism {
    class Player {
        private int nowOpenCardIndex1; //1枚目のカード
        private int nowOpenCardIndex2; //2枚目のカード

        public int BeforeOpenCardIndex1 { get; set; } //前回の1枚目
        public int BeforeOpenCardIndex2 { get; set; } //前回の2枚目
